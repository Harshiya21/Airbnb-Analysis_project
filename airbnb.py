...
if selected_option =="Home":
    ...
    tab1,tab2,tab3,tab4=st.tabs(["PRICE ANALYSIS","AVALIABILITY ANALYSIS","LOCATION ANALYSIS","GEOSPATIAL VISUALIZATION"])
    with tab1:
        ...
        with col1:
            ...
            with col2:
                ...
                property_ty= st.selectbox("Select the room type",(df2["property_type"].unique()))
    ...
    fig_bar_aa= px.bar(room_type_agg, x="host_response_time", y=["availability_30","availability_60","availability_90","availability_365"], 
                        ...
                        color_discrete_sequence=px.colors.sequential.Electric,width=600,height=600)
    ...
    with tab3:
        ...
        # # Let's start by calculating the covariance and correlation matrix
        # subset_df = df_l[["_id", "listing_url", "name", "property_type", "room_type",
        #                 "bed_type", "cancellation_policy", "cleaning_fee", "host_name",
        #                 "host_neighbourhood", "street", "country", "is_location_exact"]]

        # # Then select numeric columns for correlation
        ...
        with col1:
            ...
            fig_bar_ac= px.bar(accommodates_agg,x="accommodates", y=["bedrooms","beds","extra_people","guests_included","security_deposit"], 
                                title="Accommodates",hover_data="cleaning_fee",width= 600,height= 600,
